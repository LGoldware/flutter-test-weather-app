...
class CitySearchDelegate extends SearchDelegate {
  ...
  void _addCity(BuildContext context, CityModel item) {
    if (_controller.addCity(item)) {
      Fluttertoast.showToast(msg: "Город добавлен");
      close(context, true);
    } else {
      Fluttertoast.showToast(msg: "Город уже есть в списке");
    }
  }
}
